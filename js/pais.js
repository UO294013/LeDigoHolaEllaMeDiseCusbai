class Pais { 
    ...
    getMeteorologia() {
        ...
        const url = `http://api.openweathermap.org/data/2.5/forecast?lat=${this.coordenadas_circuito.latitud}&lon=${this.coordenadas_circuito.longitud}&appid=${apiKey}&mode=xml&lang=es&units=metric`;
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                Object.keys(daysData).forEach(fecha => {
                    ...
                    var iconUrl = `http://openweathermap.org/img/wn/${mostFrequentIcon}@2x.png`;
